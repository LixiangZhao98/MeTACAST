...
//             ProcessDenData(sw,pG,dF,data);
//         });



//     }
//     static void ProcessSLData(ParticleGroup pG, DensityField dF,NativeArray<Vector3> data)
//     {
//          Parallel.For(0, pG.GetParticlenum(), i =>
//         {
//            pG.SetMySmoothLength(data[i].x, data[i].y, data[i].z, i);//set smooth length of all the particles

//         });
//     }
//  static  void   ProcessDenData(Stopwatch sw,ParticleGroup pG, DensityField dF, NativeArray<float> data)
//     {
//         sw.Stop();
//         UnityEngine.Debug.Log("Density estimation finish in " + sw.ElapsedMilliseconds);
...
//         Parallel.For(0, dF.GetNodeNum(), i =>
//         {
//             dF.SetNodeDensity(i, data[i]); //set node density
//         });
//         float delta = 0.1f * (dF.XSTEP + dF.YSTEP + dF.ZSTEP) / 3;
//         Parallel.For(0, dF.GetNodeNum(), i =>
//         {
